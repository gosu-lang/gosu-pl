...
![Gosu::JS](http://i.imgur.com/ndYNdk4.jpg)

Gosj::JS is a [Gosu](http://gosu-lang.github.io/) extension library that allows for seamless interaction with javascript resources, leveraging Gosu's Open Type System and the [Java Nashorn](http://openjdk.java.net/projects/nashorn/) project.
...
Gosu::JS makes standard ES5-style Javascript programs available as types in Gosu.
...
The import statement in Gosu::JS acts like the java import statement, not the (unsupported) javascript version.
